                ...
                <Grid container spacing={1}>
                    ...
                    <Grid item xs={12} align="center">
                        <Collapse in ={this.state.errorMsg !="" || this.state.successMsg!=""}>
                            ...
                            <Alert  severity="success" onClick={()=>{this.setState({successMsg:""})}}>
                                {this.state.successMsg}
                                </Alert>
                                ):(
                                <Alert severity="error" onClick={()=>{this.setState({errorMsg:""})}}>
                                    {this.state.errorMsg}
                                </Alert>
                                )}
                        </Collapse>
                    ...
                    <Grid item xs={12} align="center">
                       <FormControl component="fieldset">
                        <FormHelperText>
                            ...
                            <RadioGroup row value={this.state.guestCanPause.toString()} onChange={this.handleGuestCanPauseChange}>
...
export function CreateRoomPageWithRouter(props){
    const navigate = useNavigate()
    return (<CreateRoomPage navigate={navigate} {...props}> </CreateRoomPage>)
}
